...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Hamatsu 与 ISS Black Star 及其护航无人机联队");
		api.setFleetTagline(FleetSide.ENEMY, "卢德左径 部队");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("击败所有敌军");
		api.addBriefingItem("ISS Black Star 与 ISS Hamatsu 必须存活");
		api.addBriefingItem("留在 ISS Hamatsu (友方巡洋舰) 附近以确保安全");
