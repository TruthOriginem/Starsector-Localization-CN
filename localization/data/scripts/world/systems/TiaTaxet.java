...
public class TiaTaxet {
	...
	public void generate(SectorAPI sector) {
		...
		*/
		...
		system.addAsteroidBelt(tia_star, 150, 3600, 170, 200, 250, Terrain.ASTEROID_BELT, "拉古亚环带");
		...
		SectorEntityToken tia_field1 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Tia-Ta'xet 小行星团")); // null for default name
		...
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("tia-taxet_jump", "Tia-Ta'xet 跳跃点");
